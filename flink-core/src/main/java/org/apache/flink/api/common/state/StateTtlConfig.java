...
public class StateTtlConfig implements Serializable {
    ...
    public static class Builder {
         ...
         * #cleanupInRocksdbCompactFilter(long, long)} , this setting does not disable it.
         */
        @Nonnull
    ...
    public static class RocksdbCompactFilterCleanupStrategy
        ...
        /**
         * Default value lets RocksDB control this feature as needed. For now, RocksDB will change
         * this value to 30 days (i.e 30 * 24 * 60 * 60) so that every file goes through the
         * compaction process at least once every 30 days if not compacted sooner.
         */
        static final Time DEFAULT_PERIODIC_COMPACTION_TIME = Time.seconds(0xfffffffffffffffeL);
